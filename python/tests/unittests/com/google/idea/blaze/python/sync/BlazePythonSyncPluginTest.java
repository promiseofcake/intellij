...
public class BlazePythonSyncPluginTest extends BlazeTestCase {
  ...
  public void testNoCompatibleSdk() {
    ...
    List<IntellijIdeInfo.PyIdeInfo.PythonVersion> compatibleVersions = new ArrayList<>();

    BlazePythonSyncPlugin.populateCompatibility(
        blazeProjectData, configuredVersions, compatibleVersions);
    assertThat(configuredVersions).containsExactly(PythonVersion.PY2, PythonVersion.PY3);
    assertThat(compatibleVersions).isEmpty();
  }
  ...
  public void testCompatiblePy2Sdk() {
    ...
    BlazePythonSyncPlugin.populateCompatibility(
        blazeProjectData, configuredVersions, compatibleVersions);
    assertThat(configuredVersions).containsExactly(PythonVersion.PY2, PythonVersion.PY3);
    assertThat(compatibleVersions).containsExactly(PythonVersion.PY2);
  }
  ...
  public void testCompatiblePy3Sdk() {
    ...
    BlazePythonSyncPlugin.populateCompatibility(
        blazeProjectData, configuredVersions, compatibleVersions);
    assertThat(configuredVersions).containsExactly(PythonVersion.PY2, PythonVersion.PY3);
    assertThat(compatibleVersions).containsExactly(PythonVersion.PY3);
  }
  ...
  public void testCompatiblePy2And3Sdk() {
    ...
    BlazePythonSyncPlugin.populateCompatibility(
        blazeProjectData, configuredVersions, compatibleVersions);
    assertThat(configuredVersions).containsExactly(PythonVersion.PY2, PythonVersion.PY3);
    assertThat(compatibleVersions).containsExactly(PythonVersion.PY3, PythonVersion.PY2).inOrder();
  }
